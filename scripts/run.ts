async function main() {
    ...
    console.log(await lifeContract.connect(otherAccount).callStatic.registerNodeClassifier(patientRole));
    console.log(await lifeContract.connect(otherAccount).callStatic.checkRole(patientRole));
